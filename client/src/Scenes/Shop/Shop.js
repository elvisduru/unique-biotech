      ...
      <div className={styles.Shop}>
        <div>
          ...
          <Switch>
            ...
            <Route exact path="/shop/larvae" render={(props) => <Product quantity={this.state.items[3].quantity} amount={15999.99} handleAddItem={this.handleAddItem} {...props} image={progLarvae} name="Proganics Larvae" id="larvae" description="" />} />
