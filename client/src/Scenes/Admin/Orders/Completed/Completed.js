...
export default class Completed extends Component {
  ...
  undoApproveOrder = (id) => {
    axios.put(`/api/orders/undoApprove/${id}`)
      .then(response => {
