...
export default class Declined extends Component {
  ...
  undoDeclineOrder = (id) => {
    axios.put(`/api/orders/undoDecline/${id}`)
      .then(response => {
